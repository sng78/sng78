...
- :fire: Все свободное время я отдаю обучению. В данный момент изучаю Spring Boot, Spring Security, REST, Docker. Кроме того, изучаю английский язык
...
***1. Проект "База данных работников".*** Разработал CRUD-приложение для работы с базой данных работников. Программа позволяет выводить список работников из базы данных на экран, добавлять/удалять работника, редактировать его данные [[дополнительная информация]](https://github.com/sng78/spring_mvc_hibernate_aop)

***2. Проект "Телеграм-бот NASA".*** Разработал приложение для получения астрономических изображений NASA с помощью NASA API. Интегрировал его в Telegram-бота, который по запросу публикует фотографию из космоса (изображения на сайте обновляются раз в сутки) [[дополнительная информация]](https://github.com/sng78/PicFromNasa)

***3. Проект "Поисковая система".*** Разработал серверное приложение по поиску слова среди pdf-файлов. На входе на сервер - слово, которое необходимо найти, ответ - результат в виде json-текста, с ранжированием по количеству вхождений. Реализовал клиент для демонстрации работы программы [[дополнительная информация]](https://github.com/sng78/pcs-final-diplom)

***4. Проект "Менеджер задач".*** Разработал сервер в виде отдельного класса, который принимает запросы на добавление или удаление задач из списка. Текущее состояние списка задач сервер присылает по запросу. Реализовал клиент для демонстрации работы программы [[дополнительная информация]](https://github.com/sng78/TaskManager)

***5. Проект "Менеджер личных финансов".*** Реализовал приложение, на сервер которого приходят запросы с информацией о покупке в формате json. Сервер же в ответ отдает текстовый json с информацией о максимальных категориях. Выполнил чтение и запись в файл. Реализовал клиент для демонстрации работы программы [[дополнительная информация]](https://github.com/sng78/FinanceManager)

***6. Проект "Конвертер в текстовую графику".*** Учавствовал в разработке приложения, умеющего скачивать картинки по url и конвертировать изображение в текстовую графику. Реализовал класс исключения `BadImageSizeException`, классы цветовой схемы `TextColorSchema` и конвертера картинок `TextGraphicsConverter` [[дополнительная информация]](https://github.com/sng78/Converter)
