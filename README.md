...
***1. Проект "База данных работников".*** Разработал CRUD-приложение для работы с базой данных работников. Программа позволяет выводить список работников из базы данных на экран, добавлять/удалять работника, редактировать его данные. Все операции производятся через браузер, использовал сервер Tomcat [[дополнительная информация]](https://github.com/sng78/spring_mvc_hibernate_aop)
